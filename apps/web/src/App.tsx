...
const WorldViewerPage = lazy(async () => import("./pages/WorldViewerPage"));
const WorldEditorPage = lazy(async () => import("./pages/WorldEditorPage"));
      ...
      <AppShell>
        <Suspense fallback={<RouteFallback />}>
          <Routes>
            ...
            <Route path="/viewer" element={<WorldViewerPage />} />
            <Route path="/editor" element={<WorldEditorPage />} />
